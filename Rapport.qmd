...
Tenter d'estimer directement chaque $\alpha_i$ comme un paramètre supplémentaire (approche par variables muettes) conduirait au "problème des paramètres incidents", où l'imprécision sur l'estimation des effets individuels avec un $T$ court se propage aux coefficients $\beta$, les rendant biaisés et non-consistants.
...
L'estimation des modèles Probit et Logit met en évidence une similarité des effets marginaux moyens, confirmant que les conclusions de l’étude sont robustes à la spécification de la loi utilisée. On observe un désavantage massif identifié pour les individus d'Europe de l'Est et du Maghreb, dont la probabilité d'être au chômage atteint près de **9 points de pourcentage** par rapport aux français. Pour les africains, bien que l'effet moyen estimé soit positif (environ **+3,7%**), il demeure non significatif au seuil de $5\,\%$ ($p \approx 0,19$ dans les deux modèles) ; Cette stabilité globale entre les deux approches renforce le diagnostic d'une barrière à l'emploi sélective, tout en soulignant que les difficultés structurelles ne frappent pas toutes les origines de la même manière.
