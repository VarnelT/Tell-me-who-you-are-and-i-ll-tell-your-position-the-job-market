...
La mise en œuvre de la méthode de Rivers-Vuong confirme l'exogénéité du diplôme du supérieur dans notre modèle ($p = 0,297$ pour le coefficient du résidu). L'enseignement principal de cette estimation réside dans la robustesse de la pénalité liée à l'origine : même en instrumentant le capital humain par la catégorie sociopro de la mère, les individus originaires **du Maghreb (06), d'Europe de l'Est (05) et d'Afrique (07)** subissent un sur-risque de chômage significatif comparé aux Français.
...
Toutes choses égales par ailleurs, l'analyse des effets marginaux révèle que l'origine maghrébine augmente la probabilité d'être au chômage de **10,78 points de pourcentage** par rapport aux Français. Cette difficulté d'insertion demeure massive pour les individus originaires d'Europe de l'Est, avec un écart de **7,97 points**, tandis qu'elle s'élève à **5,69 points** pour les personnes d'origine africaine.
